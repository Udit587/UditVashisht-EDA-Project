...
# EDA Course Project — US Seat Belts Dataset
...
The notebook `Phase1_EDA_USSeatBelts.ipynb` covers, in order:
...
Phase 2 and Phase 3 of the project will be added to this same repository as they are completed.
